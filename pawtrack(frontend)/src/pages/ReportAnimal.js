...
const ReportAnimal = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.condition)
      newErrors.condition = "Animal condition is required";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const payload = {
        ...
        animalCondition: formData.condition, // Rename
        urgencyLevel: formData.urgencyLevel,
        description: formData.description,
        reporterName: formData.yourName, // Rename
        phoneNumber: formData.phoneNumber,
        photoUrl: null, // optional for now
      };

      await addReport(payload); // ✅ SEND to backend
            ...
            {submissionStatus === "success" ? (
              <div className="success-message-container animate-success">
                ...
                <p className="success-text">
                  Thank you for helping an animal in need. We have received
                  your report and are notifying nearby NGOs and volunteers
                  immediately.
                </p>
                <div className="success-buttons">
                  ...
                  <button onClick={resetForm} className="success-button-primary">
              ...
              <form onSubmit={handleSubmit} noValidate className="animate-scale-in">
                ...
                <div className="form-group">
                  ...
                  <div className="select-wrapper">
                    <select
                      className={`form-select ${
                        errors.animalType ? "error-field" : ""
                      }`}
                      value={formData.animalType}
                      onChange={(e) =>
                        handleInputChange("animalType", e.target.value)
                      }
                    >
                  ...
                  {errors.animalType && (
                    <p className="error-message">{errors.animalType}</p>
                  )}
                </div>
                ...
                <div className="form-group">
                  ...
                  <div className="select-wrapper">
                    <select
                      className={`form-select ${
                        errors.urgencyLevel ? "error-field" : ""
                      }`}
                  ...
                  {errors.urgencyLevel && (
                    <p className="error-message">{errors.urgencyLevel}</p>
                  )}
                </div>
                    ...
                    {formData.photo ? (
                      ...
                      <div className="upload-placeholder">
                        ...
                        <p className="text-xs text-muted-foreground mt-1">
                          A photo helps us respond faster
                        </p>
                      </div>
                    )}
                  </div>
                ...
                <div className="privacy-notice">
                  ...
                  <p>
                    ...
                    NGOs and volunteers working on this case. We respect your
                    privacy.
                  </p>
                </div>
